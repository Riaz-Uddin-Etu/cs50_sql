...
SELECT COUNT("episode_in_season") AS "episodes_released"
FROM "episodes"
...
-- retrieve id that contain any null topic between 2010 and 2020
SELECT "id"
FROM "episodes"
WHERE ("air_date" BETWEEN '2010-01-01' AND '2020-12-31') AND "topic" IS NULL;
