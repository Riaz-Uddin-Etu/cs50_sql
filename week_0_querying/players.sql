...
-- Pittsburgh, Pennsylvania (PA). Sort the results first by debut date—from most recent to oldest—then
...
SELECT COUNT("id") AS "Number of Players"
FROM "players"
...
SELECT MAX("weight") AS "Maximum weight", MIN("weight") AS "Minimum weight"
FROM "players"
WHERE "debut" > '2000-01-01'
ORDER BY "debut" DESC;
