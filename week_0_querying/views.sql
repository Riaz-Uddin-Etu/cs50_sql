...
-- In 2.sql, write a SQL query to list the average colors of prints by Hokusai that
-- include “river” in the English title. (As an aside, do they have any hint of blue?)
...
SELECT COUNT("english_title") AS "number_of_fuji_in_english_title"
FROM "views"
...
SELECT SUM("entropy") AS "total_entropy_of_prints_included_Edo_by_Hokusai"
FROM "views"
WHERE "artist" = 'Hokusai' AND "english_title" LIKE '%Edo%'
ORDER BY "entropy";
